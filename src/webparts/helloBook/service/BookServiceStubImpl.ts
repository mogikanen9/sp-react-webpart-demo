...
const INIT_BOOK_DATA = [
    ...
    {
        name: "Java Concurrency in Practice", isbn: "0321349601",
        description: "Comprehensive coverage on one of the most advanced topics in Java",
        pubDate: new Date('2006-07-23')
    },
    {
        name: "Refactoring: Improving the Design of Existing Code", isbn: "0201485672",
        description: "Code refactoring", pubDate: new Date('1999-12-17')
    },
    {
        name: "Building Microservices: Designing Fine-Grained Systems", isbn: "1491950358",
        description: "Microservices", pubDate: new Date('2013-6-11')
    },
    {
        name: "Java Programming Interviews Exposed", isbn: "1118722868",
